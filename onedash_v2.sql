...
drop table if exists temp.app_ads_department_module_okr_dash_td_v2_df_{{ds_nodash}}_001;
create table if not exists temp.app_ads_department_module_okr_dash_td_v2_df_{{ds_nodash}}_001 as
select 
   a.date_key
  ,a.module
  ,a.product
...
--20230508增加非闭环电商收入
drop table if exists temp.app_ads_department_module_okr_dash_td_v2_df_{{ds_nodash}}_002;
create table if not exists temp.app_ads_department_module_okr_dash_td_v2_df_{{ds_nodash}}_002 as
select 
   a.date_key
  ,a.module
  ,case 
...
drop table if exists temp.app_ads_department_module_okr_dash_td_v2_df_{{ds_nodash}}_003;
create table if not exists temp.app_ads_department_module_okr_dash_td_v2_df_{{ds_nodash}}_003 as
select 
   a.date_key
...
drop table if exists temp.app_ads_department_module_okr_dash_td_v2_df_{{ds_nodash}}_004;
create table temp.app_ads_department_module_okr_dash_td_v2_df_{{ds_nodash}}_004 as
select
  a.date_key
  ,a.module
  ,a.department
...
(
  ...
  (
    ...
    (
      ...
      from temp.app_ads_department_module_okr_dash_td_v2_df_{{ds_nodash}}_001 a 
      where cost > 0
      --and department = '行业团队'
...
--mtd数据--广告整体-行业数据整体
drop table if exists temp.app_ads_department_module_okr_dash_td_v2_df_{{ds_nodash}}_005;
create table temp.app_ads_department_module_okr_dash_td_v2_df_{{ds_nodash}}_005 as
select
  a.date_key
  ,a.module
  ,a.department
...
(
  ...
  (
    ...
    (select department
      ,1 as tag
    from temp.app_ads_department_module_okr_dash_td_v2_df_{{ds_nodash}}_001
    where  module in ('品牌','效果','薯条')
    group by department
    )dim 
    join 
...
;
--mtd数据--广告整体-行业数据分部门
drop table if exists temp.app_ads_department_module_okr_dash_td_v2_df_{{ds_nodash}}_006;
create table temp.app_ads_department_module_okr_dash_td_v2_df_{{ds_nodash}}_006 as
select
  a.date_key
  ,a.module
  ,a.department
...
;
insert overwrite table redapp.app_ads_department_module_okr_dash_td_v2_df partition(dtm = '{{ ds_nodash }}')
select 
   date_key
  ,'广告整体' as module
  ,'商业部' as department
 ...
 , ads_campany_num_mtd
from 
  temp.app_ads_department_module_okr_dash_td_v2_df_{{ds_nodash}}_004 a
...
from 
  temp.app_ads_department_module_okr_dash_td_v2_df_{{ds_nodash}}_001 a 
group by 
  1,2
union all 
select 
...
select 
  ...
  ,0 as ads_campany_num_mtd
from 
  temp.app_ads_department_module_okr_dash_td_v2_df_{{ds_nodash}}_002 a 
group by 
  1,2
union all 
select 
 ...
 ,ads_campany_num_mtd
from 
  temp.app_ads_department_module_okr_dash_td_v2_df_{{ds_nodash}}_005 a
...
select 
 ...
 , ads_campany_num_mtd
from 
  temp.app_ads_department_module_okr_dash_td_v2_df_{{ds_nodash}}_006 a
union all 
select 
   a.date_key
  ,a.module
...
select a.date_key
  ...
  ,0 as ads_campany_num --日消耗客户数
  ,0 as ads_campany_num_mtd
from temp.app_ads_department_module_okr_dash_td_v2_df_{{ds_nodash}}_003 a 
group by 
  1,2,3,4
;
