...
--全量子账户产品以及当前和上小时
drop table if exists temp.dm_ads_rtb_advertiser_metric_hi_01{{ds_nodash}}_{{ts[11:13]}}_1;
create table temp.dm_ads_rtb_advertiser_metric_hi_01{{ds_nodash}}_{{ts[11:13]}}_1
select
  virtual_seller_id,
  advertiser_id,
  hh,
...
from
  ...
  on 1=1
;
drop table if exists temp.dm_ads_rtb_advertiser_metric_hi_02{{ds_nodash}}_{{ts[11:13]}}_1;
create table temp.dm_ads_rtb_advertiser_metric_hi_02{{ds_nodash}}_{{ts[11:13]}}_1
 --账户小时余额
  select
  ...
  group by
    ...
    2,3
    ;
drop table if exists temp.dm_ads_rtb_advertiser_metric_hi_03{{ds_nodash}}_{{ts[11:13]}}_1;
create table temp.dm_ads_rtb_advertiser_metric_hi_03{{ds_nodash}}_{{ts[11:13]}}_1
 -- --账户离线日预算
  -- select granularity,
  --   advertiser_id,
  --   product,
...
;
drop table if exists temp.dm_ads_rtb_advertiser_metric_hi_04{{ds_nodash}}_{{ts[11:13]}}_1;
create table temp.dm_ads_rtb_advertiser_metric_hi_04{{ds_nodash}}_{{ts[11:13]}}_1
...
from temp.dm_ads_rtb_advertiser_metric_hi_03{{ds_nodash}}_{{ts[11:13]}}_1 t1 
full outer join 
(select *
from temp.dm_ads_rtb_advertiser_metric_hi_03{{ds_nodash}}_{{ts[11:13]}}_1
...
;
drop table if exists temp.advertiser_info_alias{{ds_nodash}}_{{ts[11:13]}}_1;
create table temp.advertiser_info_alias{{ds_nodash}}_{{ts[11:13]}}_1
...
;
drop table if exists temp.advertiser_cost_alias{{ds_nodash}}_{{ts[11:13]}}_1;
create table temp.advertiser_cost_alias{{ds_nodash}}_{{ts[11:13]}}_1
...
;
--20231117新增小时级互动转化
drop table if exists temp.advertiser_engage_alias{{ds_nodash}}_{{ts[11:13]}}_1;
create table temp.advertiser_engage_alias{{ds_nodash}}_{{ts[11:13]}}_1
  ...
  group by advertiser_id,
    ...
    hh
;
drop table if exists temp.advertiser_balance_alias{{ds_nodash}}_{{ts[11:13]}}_1;
create table temp.advertiser_balance_alias{{ds_nodash}}_{{ts[11:13]}}_1
...
from temp.dm_ads_rtb_advertiser_metric_hi_02{{ds_nodash}}_{{ts[11:13]}}_1 t1 
full outer join 
(select *
from temp.dm_ads_rtb_advertiser_metric_hi_02{{ds_nodash}}_{{ts[11:13]}}_1
where after_hh is not null
)t2 on t1.hh=t2.after_hh and t1.virtual_seller_id=t2.virtual_seller_id
;
drop table if exists temp.dm_ads_rtb_advertiser_metric_hi_info{{ds_nodash}}_{{ts[11:13]}}_1;
create table temp.dm_ads_rtb_advertiser_metric_hi_info{{ds_nodash}}_{{ts[11:13]}}_1
select
...
from
  (
    select
      ...
      t0.virtual_seller_id,
      sum(coalesce(if(t1.hh = t0.hh, cost_1h, 0), 0)) as cost_1h,
      sum(
        coalesce(if(t1.hh = t0.hh, yesterday_cost_1h, 0), 0)
      ) as ystd_cost_1h,
      sum(coalesce(if(t1.hh <= t0.hh, cost_1h, 0), 0)) as cost_1d,
      sum(
        coalesce(if(t1.hh <= t0.hh, yesterday_cost_1h, 0), 0)
      ) as ystd_cost_1d,
    ...
    from
      temp.dm_ads_rtb_advertiser_metric_hi_01{{ds_nodash}}_{{ts[11:13]}}_1 t0
      inner join temp.advertiser_cost_alias{{ds_nodash}}_{{ts[11:13]}}_1 t1 on t0.advertiser_id = t1.advertiser_id
      and t0.product = t1.product
      and t0.market_target_type = t1.market_target_type
      left join 
      temp.dm_ads_rtb_advertiser_metric_hi_04{{ds_nodash}}_{{ts[11:13]}}_1 t2 on t0.advertiser_id = t2.advertiser_id
    ...
    from
      (
        ...
        from
          temp.dm_ads_rtb_advertiser_metric_hi_01{{ds_nodash}}_{{ts[11:13]}}_1
        group by
          1,
          2,
          3,
      ...
      left join temp.dm_ads_rtb_advertiser_metric_hi_04{{ds_nodash}}_{{ts[11:13]}}_1 t2 on t0.advertiser_id = t2.advertiser_id
      and t0.product = t2.product
      where tag = 2
    union all
    select
    ...
    from
      ...
      left join temp.advertiser_balance_alias{{ds_nodash}}_{{ts[11:13]}}_1 t1 on t0.virtual_seller_id = t1.virtual_seller_id
      and t0.hh = t1.hh
      left join 
      (select *
      from temp.dm_ads_rtb_advertiser_metric_hi_04{{ds_nodash}}_{{ts[11:13]}}_1 
      where tag = 3
      )t2 on t0.advertiser_id = t2.advertiser_id
  ) t0
  left join temp.advertiser_info_alias{{ds_nodash}}_{{ts[11:13]}}_1 t1 on t0.virtual_seller_id = t1.virtual_seller_id
  where t0.hh<=(select max(hh) from temp.advertiser_balance_alias{{ds_nodash}}_{{ts[11:13]}}_1)
  ;
insert
  overwrite table redcdm.dm_ads_rtb_advertiser_metric_hi partition (dtm, hh)
select virtual_seller_id,
  t1.product,
  ...
  dtm,
  t1.hh
from temp.dm_ads_rtb_advertiser_metric_hi_info{{ds_nodash}}_{{ts[11:13]}}_1 t1
left join 
...
from temp.dm_ads_rtb_advertiser_metric_hi_info{{ds_nodash}}_{{ts[11:13]}}_1
